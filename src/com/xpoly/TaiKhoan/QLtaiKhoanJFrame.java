 ...
 * @author 77 thai ha
 */
public class QLtaiKhoanJFrame extends javax.swing.JFrame implements IService<NguoiDung> {
   ...
   return "Admin";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QLtaiKhoanJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QLtaiKhoanJFrame().setVisible(true);
            }
        });
    }
